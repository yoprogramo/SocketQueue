...
exports.format = {
  ...
  '23': {
    length: 3,
    name:   'Numero de secuencia de la tarjeta',
    type:   'fixed-hn',
    alias:  ''
  },
  '24': {
  ...
  '93' : {
    length: 6,
    name: 'Codigo de identificación de destino',
    type: 'll-bin-hn',
    alias: ''
  },
  '94' : {
    length: 6,
    name: 'Codigo de identificación de origen',
    type: 'll-bin-hn',
    alias: ''
  }
};
...
exports.validators = {
  ...
  isExpiredPacket: function(packet, expirationLimitSeconds) {
    // Ñapa temporal para pruebas... Eliminar
    return false;
    // 150630200039
    // YYMMDDHHmmss
